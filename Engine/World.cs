...
namespace Engine
{
    ...
    {
        //List of all ITEMS, MONSTERS, QUESTS, LOCATIONS
        ...
        {
            //ctor id,name,description,rewardxp,rewardgold
